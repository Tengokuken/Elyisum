Public Class frmWaterRuins
    Dim collisionArray(49) As Control
    Private Sub UpKey()
        PictureBox1.Top += 5
        PictureBox2.Top += 5
        PictureBox3.Top += 5
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        End If
    End Sub
    Private Sub frmWaterRuins_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        collisionArray(46) = PictureBox5
        collisionArray(47) = PictureBox6
        collisionArray(48) = PictureBox7
        collisionArray(49) = PictureBox8
        Me.CenterToScreen()
        area = "Underwater Ruins"
    End Sub
