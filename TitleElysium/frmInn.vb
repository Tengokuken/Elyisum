Public Class frmInn
    Dim collisionArray(37) As Control
    Private Sub UpKey()
        PictureBox1.Top += 5
        PictureBox2.Top += 5
        PictureBox3.Top += 5
    ...
    Private Sub CharacterIntialization()
        ...
        If PictureBox1.Bounds.IntersectsWith(Label41.Bounds) Then
            person4 = True
        ElseIf PictureBox1.Bounds.IntersectsWith(Label42.Bounds) Then
            girl2 = True
        End If
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        End If
    End Sub
    Private Sub frmInn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        collisionArray(35) = Label37
        collisionArray(36) = PictureBox8
        collisionArray(37) = PictureBox6
        Me.CenterToScreen()
        area = "Inn"
    End Sub
End Class